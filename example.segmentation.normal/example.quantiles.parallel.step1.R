...
ppmcd.logdet.raw   = -smooth.monotonic(n.in:n.max, colMeans(ppmcd.logdet.raw))
fastmcd.logdet.raw = -smooth.monotonic(n.in:n.max, colMeans(fastmcd.logdet.raw))
detmcd.logdet.raw  = -smooth.monotonic(n.in:n.max, colMeans(detmcd.logdet.raw))
